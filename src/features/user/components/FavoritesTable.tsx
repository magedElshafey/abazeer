                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="w-16 h-16 bg-gray-200 rounded flex items-center justify-center overflow-hidden">
                                                {product.image ? (
                                                    ...
                                                    <div className="text-gray-500 text-xs">600 x 600</div>
                                                )}
                                            </div>
                                            <div className="flex flex-col">
                                                <Link
                                                    to={`/products/${product.id}`}
                                                    className="font-medium text-gray-900 text-sm hover:text-orangeColor transition-colors"
                                                >
                                                    {product.name}
                                                </Link>
                                                <p className="text-gray-500 text-xs">
                                                    {t("category")}: <span className="text-orangeColor">{product.category}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="py-4 px-6">
                                        <div className="flex flex-col">
                                            <span className="text-red-600 font-medium">
                                                {product.has_discount ? product.sale_price : formatPrice(product.price)} {t("SAR")}
                                            </span>
