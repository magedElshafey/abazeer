                            ...
                            >
                                <div className="flex flex-col flex-1 justify-between">
                                    ...
                                    <div className="flex flex-col gap-1 text-sm text-gray-600">
                                        <div>
                                            <span className="font-medium">{t("payment_status")}:</span> {order.payment_status}
                                        </div>
                                        {order.payment_method && (
                                            <div>
                                                <span className="font-medium">{t("payment_method")}:</span> {order.payment_method}
                                            </div>
                                        )}
                                    </div>
                                </div>
                                <div className="flex flex-col justify-between gap-4">
                                    <div className="flex items-center gap-3">
                                        <span 
                                            className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(order.order_status_label)}`}
                                        >
                                            {order.order_status}
                                        </span>
